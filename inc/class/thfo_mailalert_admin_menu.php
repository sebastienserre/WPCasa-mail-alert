...
class thfo_mailalert_admin_menu {
	...
	public function thfo_admin_menu(){
		add_menu_page(__('Mail Alert', 'wpcasa-mail-alert'),__('Mail Alert', 'wpcasa-mail-alert'),'manage_options','wpcasa-mail-alert', array($this, 'thfo_menu_html'),WPCASAMA_PLUGIN_URL . '/assets/img/icon.png');
	...
	public function thfo_max_price(){
        ...
        $value .= sprintf( wp_kses( __( 'More options in the PRO Version <a href="%s">Here</a>.', 'wpcasa-mail-alert' ), array(  'a' => array( 'href' => array() ) ) ), esc_url( $url ) );
        $value .= '</div>';
